...
const Footer = () => {
  ...
  if (!footer) return <footer className="py-12 text-center text-white/70">Footer content unavailable</footer>;
          ...
          <div>
            ...
            <ul className="space-y-2">
              {footer.quickLinks.map((link) => (
                <li key={link.label}>
                  <Link to={link.href} className="text-white/70 hover:text-purple-300 transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
