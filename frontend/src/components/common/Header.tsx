      ...
      <header className="glass-nav fixed top-0 left-0 right-0 z-50 px-4 py-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between">
            <Link to="/" className="font-display text-2xl font-bold text-white hover-glow">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button onClick={handleAdminAccess} className="glass-button p-2 hover-lift" title="Admin Access">
                <Shield className="w-5 h-5" />
              </button>

              <button onClick={() => setShowAuthModal(true)} className="glass-button p-2 hover-lift">
